...
def update_server(name, hostname, port, username, password, domain, dbrootpasswd, dbuse, dbusepasswd):
    try:
        ...
        command = '''wget -O /home/web/docker-compose.yml https://raw.githubusercontent.com/awasle/docker/main/LNMP-docker-compose-4.yml && \
                     sed -i "s/webroot/{}/g" /home/web/docker-compose.yml && \
                     sed -i "s/awasleYYDS/{}/g" /home/web/docker-compose.yml && \
                     sed -i "s/awasle/{}/g" /home/web/docker-compose.yml'''.format(dbrootpasswd, dbusepasswd, dbuse)
