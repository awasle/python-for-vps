...
def update_server(name, hostname, port, username, password, domain, dbrootpasswd, dbuse, dbname ):
    try:
        ...
        stdin, stdout, stderr = client.exec_command('wget -O /home/web/conf.d/' + domain + '.conf https://raw.githubusercontent.com/awasle/nginx/main/maccms.com.conf && \
        ...
        command = (
            ...
            'cd /home/web/html/{}/maccms10-master/template/ && wget https://github.com/awasle/Website_source_code/raw/main/DYXS2.zip && unzip DYXS2.zip && rm /home/web/html/{}/maccms10-master/template/DYXS2.zip && '
            ...
            'mv /home/web/html/{}/maccms10-master/admin.php /home/web/html/{}/maccms10-master/vip.php && wget -O /home/web/html/{}/maccms10-master/application/extra/maccms.php https://raw.githubusercontent.com/awasle/Website_source_code/main/maccms.php'
