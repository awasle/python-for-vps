...
def update_server(name, hostname, port, username, password, domain):
    try:
        ...
        stdin, stdout, stderr = client.exec_command('wget -O /home/web/nginx.conf https://raw.githubusercontent.com/awasle/nginx/main/nginx6.conf && sed -i "s/yuming.com/' + domain + '/g" /home/web/nginx.conf')
        while not stdout.channel.exit_status_ready():
            if stdout.channel.recv_ready():
                print(stdout.channel.recv(1024).decode(), end="")
        ...
        stdin, stdout, stderr = client.exec_command('wget -O /home/web/docker-compose.yml https://raw.githubusercontent.com/awasle/docker/main/LNMP-docker-compose-1.yml')
        while not stdout.channel.exit_status_ready():
            if stdout.channel.recv_ready():
                print(stdout.channel.recv(1024).decode(), end="")
        ...
        stdin, stdout, stderr = client.exec_command('cd /home/web/html/template/ && wget https://github.com/awasle/Website_source_code/raw/main/DYXS2.zip && unzip DYXS2.zip && rm /home/web/html/template/DYXS2.zip && cp /home/web/html/template/DYXS2/asset/admin/Dyxs2.php /home/web/html/application/admin/controller && cp /home/web/html/template/DYXS2/asset/admin/dycms.html /home/web/html/application/admin/view/system')
        while not stdout.channel.exit_status_ready():
            if stdout.channel.recv_ready():
                print(stdout.channel.recv(1024).decode(), end="")
        ...
        stdin, stdout, stderr = client.exec_command('mv /home/web/html/admin.php /home/web/html/vip.php && wget -O /home/web/html/application/extra/maccms.php https://raw.githubusercontent.com/awasle/Website_source_code/main/maccms.php')
        while not stdout.channel.exit_status_ready():
            if stdout.channel.recv_ready():
                print(stdout.channel.recv(1024).decode(), end="")
